...
export class SalesComponent implements OnInit {
  ...
  public totalSoldProducts: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.orderService.loadOrderHistory().then((orders) => {
      ...
      this.totalSoldProducts = orders.reduce((total, order) => {
        return total + Object.values(order.products).reduce((sum, quantity) => sum + quantity, 0);
      }, 0);
